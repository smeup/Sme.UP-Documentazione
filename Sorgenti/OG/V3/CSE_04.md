...
![CM1](http://localhost:3000/immagini/MBDOC_OGG-V3_CSE_04/CM1.png)
...
![CM2](http://localhost:3000/immagini/MBDOC_OGG-V3_CSE_04/CM2.png)
- Dopo aver impostato i path, selezionare il connettore per il Content Manager V8

![CM3](http://localhost:3000/immagini/MBDOC_OGG-V3_CSE_04/CM3.png)
Ed esempi associati
![CM4](http://localhost:3000/immagini/MBDOC_OGG-V3_CSE_04/CM4.png)
...
![CM5](http://localhost:3000/immagini/MBDOC_OGG-V3_CSE_04/CM5.png)

- Impostare la password dell'utente "icmconct"

![CM6](http://localhost:3000/immagini/MBDOC_OGG-V3_CSE_04/CM6.png)
...
![G53](http://localhost:3000/immagini/MBDOC_OGG-V3_CSE_04/G53.png)
