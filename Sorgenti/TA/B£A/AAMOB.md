...
![AAP_MOB_01](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_01.png)
...
![AAP_MOB_02](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_02.png)In TwinPulse Application Builder esiste un unico contenitore di form, dove esse sono create e manutenzionate e un unico contenitore degli utenti aziendali. Dentro alle form possiamo inserire immagini e collezioni di dati. Quando parliamo di immagini, intendiamo ad es. il logo della compagnia, le immagini dei prodotti, foto di persone o altro. Anche le immagini sono in un opportuno contenitore e possono essere usate in diverse form.
...
![AAP_MOB_04](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_04.png)Una volta che immagini e collezioni sono state definite, possiamo iniziare a usare l'editor delle form. Una form è una schermata del palmare, e per questo sono state costruite una serie di componenti predefiniti.
...
![AAP_MOB_05](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_05.png)![AAP_MOB_06](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_06.png)![AAP_MOB_07](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_07.png)Dopo la creazione di uno scenario, possiamo procedere ad aggiungere in esso i form che dovranno farne parte. Questa attività si può fare semplicemente con il tasto destro del mouse, scegliendo Attach Forms.
![AAP_MOB_08](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_08.png)Eseguita questa operazione, il sistema mostra la lista di tutti i form disponibili, da cui scegliere quelli che servono.
![AAP_MOB_09](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_09.png)Per concludere, con lo sviluppo dello scenario è necessario aggiungere gli utenti che saranno autorizzati a operare.
![AAP_MOB_10](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_10.png)Definito lo scenario con le sue proprietà, occorre occuparsi dei palmari che saranno connessi al TwinPulse SyncServer.
![AAP_MOB_11](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_11.png)# Twinpulse Everywhere
![AAP_MOB_12](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_12.png)Questo componente è installato in ogni client e ha il duplice scopo di organizzare le comunicazioni con il sincronizzatore SyncServer e consente all'utente l'uso delle possibilità operative previste dagli scenari.
...
![AAP_MOB_13](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_13.png)
...
![AAP_MOB_14](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_14.png)
...
![AAP_MOB_15](http://doc.smeup.com/immagini/MBDOC_VIS-AAMOB/AAP_MOB_15.png)
