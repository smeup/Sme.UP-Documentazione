E' destinata al personale tecnico per visualizzare il contenuto della memoria della schedulazione, per una comprensione più profonda del processo e per analizzare anomalie e particolarità.
